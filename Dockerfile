...
ENV GIT_EMAIL="your_email@example.com" GIT_NAME="developer" GIT_RSA="GIT_RSA" GIT_RSA_PUB="GIT_RSA_PUB"
...
ADD --chown=${USERNAME} ./start.sh ${HOME_BASE}/${USERNAME}/init/start.sh
ADD --chown=${USERNAME} ./install.sh ${HOME_BASE}/${USERNAME}/init/install.sh
